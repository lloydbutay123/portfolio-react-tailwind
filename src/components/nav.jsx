...
const Nav = ({ darkMode, setDarkMode }) => {
  ...
  return (
    <header className="flex fixed w-full z-50 pl-[16px] justify-between">
      <nav className="flex justify-between w-full">
        <div className="flex items-center">
          <a href="#hero" className="dark:text-white">HOME</a>
        </div>
        <div className="flex items-center bg-white w-[96px] h-[96px] p-[16px] rounded-tl-[20px] rounded-b-[20px]" >
