...
const footer = () => {
  ...
  return (
    <footer className="lg:p-[24px] dark:bg-black" id="footer">
      <div className="block lg:flex flex-col lg:rounded-[60px] w-full bg-black dark:bg-white text-white px-[24px] py-[96px] lg:px-[96px] xl:px-[136px]">
        <div className="flex flex-col gap-[72px]">
          <AnimatedComponent
            className="grid place-items-center gap-[40px]"
            animationType="slideBottom"
          >
            <h1 className="text-[48px] dark:text-black lg:text-[84px] leading-[1em] text-center max-w-[700px]">
              Let's create your next big idea.
            </h1>
            <button
              className="flex items-center gap-3 text-[18px] dark:text-white bg-white dark:bg-black px-[24px] py-[12px] text-black rounded-[30px] font-medium"
              onClick={() => navigate("/contact")}
            >
              Schedule a call {<IoSendSharp />}
            </button>
          </AnimatedComponent>
          <div className="block justify-between mb-5 md:mb-0">
            ...
            <div className="flex flex-wrap border-b-2 md:border-none border-gray-400 gap-5 pb-10 md:pb-0">
              {SocialsLists.map((social) => {
                return (
                  <a
                    className="text-[14px] dark:text-black font-medium"
                    href={social.link}
                    target="_blank"
        ...
        <div className="flex gap-5 justify-between">
          ...
          <div className="block">
            ...
            <p className="text-sm dark:text-black uppercase">
